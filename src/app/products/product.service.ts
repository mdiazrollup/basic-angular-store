...
export class ProductService {
  ...
  initProducts() {
    ...
    .get<Product[]>(url)
    .pipe(
      delay(2000), // add a delay after getting result. Fort test purpose
      tap(console.table),  // show the results  . Equal to data => console.log(data)
      shareReplay(), // Keep the last data in memory
